...
exports.RbacModule = RbacModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [jwt_auth_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard],
        exports: [jwt_auth_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard],
    })
], RbacModule);
