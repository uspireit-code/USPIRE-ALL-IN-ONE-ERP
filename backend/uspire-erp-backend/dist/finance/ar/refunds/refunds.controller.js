...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.Permissions)('REFUND_VIEW'),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('REFUND_CREATE'),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('REFUND_APPROVE'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('REFUND_POST'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('REFUND_VOID'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
