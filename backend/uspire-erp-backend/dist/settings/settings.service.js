...
let SettingsService = class SettingsService {
    ...
    async ensureFinanceOfficerRole(tenantId) {
        ...
        const allowedPermissionCodes = [
            permission_catalog_1.PERMISSIONS.AR.INVOICE_CREATE_RBAC,
            permission_catalog_1.PERMISSIONS.AR.INVOICE_CREATE,
            permission_catalog_1.PERMISSIONS.AR.INVOICE_EDIT_DRAFT,
            permission_catalog_1.PERMISSIONS.AR.INVOICE_VIEW_RBAC,
            permission_catalog_1.PERMISSIONS.AR.INVOICE_VIEW,
            permission_catalog_1.PERMISSIONS.AR.RECEIPT_CREATE_RBAC,
            permission_catalog_1.PERMISSIONS.AR.RECEIPT_CREATE,
            permission_catalog_1.PERMISSIONS.AR.RECEIPT_VIEW_RBAC,
            permission_catalog_1.PERMISSIONS.AR.RECEIPT_VIEW,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_CREATE_RBAC,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_CREATE,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_SUBMIT_RBAC,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_SUBMIT,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_VIEW_RBAC,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_VIEW,
            permission_catalog_1.PERMISSIONS.AR.REFUND_CREATE_RBAC,
            permission_catalog_1.PERMISSIONS.AR.REFUND_CREATE,
            permission_catalog_1.PERMISSIONS.AR.REFUND_SUBMIT_RBAC,
            permission_catalog_1.PERMISSIONS.AR.REFUND_SUBMIT,
            permission_catalog_1.PERMISSIONS.AR.REFUND_VIEW_RBAC,
            permission_catalog_1.PERMISSIONS.AR.REFUND_VIEW,
            permission_catalog_1.PERMISSIONS.AR.INVOICE_CATEGORY_VIEW,
            permission_catalog_1.PERMISSIONS.TAX.RATE_VIEW,
            permission_catalog_1.PERMISSIONS.GL.VIEW,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.DEPARTMENT.VIEW,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.PROJECT.VIEW,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.FUND.VIEW,
            permission_catalog_1.PERMISSIONS.AP.SUPPLIER_CREATE,
            permission_catalog_1.PERMISSIONS.AP.SUPPLIER_VIEW,
    ...
    async ensureFinanceManagerRole(tenantId) {
        ...
        const allowedPermissionCodes = [
            permission_catalog_1.PERMISSIONS.GL.VIEW,
            permission_catalog_1.PERMISSIONS.GL.APPROVE,
            permission_catalog_1.PERMISSIONS.GL.RECURRING_MANAGE,
            permission_catalog_1.PERMISSIONS.GL.RECURRING_GENERATE,
            permission_catalog_1.PERMISSIONS.COA.VIEW,
            permission_catalog_1.PERMISSIONS.BUDGET.FINANCE_VIEW,
            permission_catalog_1.PERMISSIONS.AP.SUPPLIER_CREATE,
            permission_catalog_1.PERMISSIONS.AP.SUPPLIER_VIEW,
            permission_catalog_1.PERMISSIONS.AP.SUPPLIER_IMPORT,
            permission_catalog_1.PERMISSIONS.AP.INVOICE_VIEW,
            ...
            permission_catalog_1.PERMISSIONS.PERIOD.CHECKLIST_COMPLETE,
            permission_catalog_1.PERMISSIONS.PERIOD.CLOSE,
            permission_catalog_1.PERMISSIONS.REPORT.TB_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.CASHFLOW_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.SOE_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.DISCLOSURE_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.PRESENTATION_PL_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.PRESENTATION_BS_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.REPORT_EXPORT,
            permission_catalog_1.PERMISSIONS.AR.RECEIPT_VIEW,
            permission_catalog_1.PERMISSIONS.AR.RECEIPT_POST,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_VIEW,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_APPROVE,
            permission_catalog_1.PERMISSIONS.AR.REFUND_VIEW,
            permission_catalog_1.PERMISSIONS.AR.REFUND_APPROVE,
        ];
        const perms = await this.prisma.permission.findMany({
            where: { code: { in: [...allowedPermissionCodes] } },
            select: { id: true },
    ...
    async ensureFinanceControllerRole(tenantId) {
        ...
        const allowedPermissionCodes = [
            permission_catalog_1.PERMISSIONS.GL.VIEW,
            permission_catalog_1.PERMISSIONS.GL.FINAL_POST,
            permission_catalog_1.PERMISSIONS.PERIOD.VIEW,
            permission_catalog_1.PERMISSIONS.PERIOD.CREATE,
            permission_catalog_1.PERMISSIONS.PERIOD.CLOSE,
            permission_catalog_1.PERMISSIONS.PERIOD.CHECKLIST_VIEW,
            permission_catalog_1.PERMISSIONS.PERIOD.CHECKLIST_COMPLETE,
            permission_catalog_1.PERMISSIONS.COA.VIEW,
            permission_catalog_1.PERMISSIONS.COA.UPDATE,
            permission_catalog_1.PERMISSIONS.BUDGET.FINANCE_VIEW,
            permission_catalog_1.PERMISSIONS.FINANCE.CONFIG_VIEW,
            permission_catalog_1.PERMISSIONS.FINANCE.CONFIG_UPDATE,
            permission_catalog_1.PERMISSIONS.FINANCE.CONFIG_CHANGE,
            permission_catalog_1.PERMISSIONS.AR.RECEIPT_VIEW,
            permission_catalog_1.PERMISSIONS.AR.INVOICE_VIEW,
            ...
            permission_catalog_1.PERMISSIONS.MASTER_DATA.PROJECT.VIEW,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.PROJECT.CREATE,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.PROJECT.EDIT,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.PROJECT.CLOSE,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.FUND.VIEW,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.FUND.CREATE,
            permission_catalog_1.PERMISSIONS.MASTER_DATA.FUND.EDIT,
            permission_catalog_1.PERMISSIONS.REPORT.TB_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.CASHFLOW_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.SOE_VIEW,
            permission_catalog_1.PERMISSIONS.REPORT.DISCLOSURE_VIEW,
            ...
            permission_catalog_1.PERMISSIONS.AR.RECEIPT_POST,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_VIEW,
            permission_catalog_1.PERMISSIONS.AR.CREDIT_NOTE_POST,
            permission_catalog_1.PERMISSIONS.AR.REFUND_VIEW,
            permission_catalog_1.PERMISSIONS.AR.REFUND_POST,
        ];
        const perms = await this.prisma.permission.findMany({
            where: { code: { in: [...allowedPermissionCodes] } },
            select: { id: true },
    ...
    async createUser(req, dto) {
        ...
        await this.prisma.auditEvent
            ...
            data: {
                ...
                userId: actor.id,
                permissionUsed: permission_catalog_1.PERMISSIONS.USER.CREATE,
            },
        })
            .catch(() => undefined);
        return {
    ...
    async updateUserStatus(req, id, dto) {
        ...
        await this.prisma.auditEvent
            ...
            data: {
                ...
                userId: actor.id,
                permissionUsed: permission_catalog_1.PERMISSIONS.USER.EDIT,
            },
        })
            .catch(() => undefined);
        return {
    ...
    async updateUserRoles(req, id, dto) {
        ...
        await this.prisma.auditEvent
            ...
            data: {
                ...
                userId: actor.id,
                permissionUsed: permission_catalog_1.PERMISSIONS.ROLE.ASSIGN,
            },
        })
            .catch(() => undefined);
        return out;
    ...
    async getSystemConfig(req) {
        ...
        return {
            ...row,
            arRefundClearingAccountId: row.defaultBankClearingAccountId ?? null,
            arCashClearingAccountId: row.cashClearingAccountId ?? null,
            logoUrl: row.logoUrl ? '/settings/organisation/logo' : null,
    ...
    async updateSystemConfig(req, dto) {
        ...
        const isChangingFinanceControls = financeSensitiveKeys.some((k) => dto?.[k] !== undefined);
        const isChangingNonFinanceControls = Object.keys(dto).some((k) => {
            if (dto?.[k] === undefined)
                return false;
            return !financeSensitiveKeys.includes(k);
        });
        if (isChangingNonFinanceControls) {
            const hasSystemConfigUpdate = await this.prisma.rolePermission.findFirst({
                where: {
                    ...
                    permission: { code: permission_catalog_1.PERMISSIONS.SYSTEM.CONFIG_UPDATE },
                },
                select: { roleId: true },
            });
            if (!hasSystemConfigUpdate) {
                throw new common_1.ForbiddenException({
                    error: 'Access denied',
                    missingPermissions: [permission_catalog_1.PERMISSIONS.SYSTEM.CONFIG_UPDATE],
                });
            }
        }
        if (isChangingFinanceControls) {
            const hasFinanceConfig = await this.prisma.rolePermission.findFirst({
                where: {
                    ...
                    permission: { code: { in: [permission_catalog_1.PERMISSIONS.FINANCE.CONFIG_UPDATE, permission_catalog_1.PERMISSIONS.FINANCE.CONFIG_CHANGE] } },
                },
                select: { roleId: true },
            });
            if (!hasFinanceConfig) {
                throw new common_1.ForbiddenException({
                    error: 'Access denied',
                    missingPermissions: [permission_catalog_1.PERMISSIONS.FINANCE.CONFIG_UPDATE],
                });
            }
        }
        ...
        const updated = await this.prisma.tenant.update({
            ...
            data: {
                ...
                requiresDepartmentOnInvoices: dto.requiresDepartmentOnInvoices === undefined
                    ? undefined
                    : dto.requiresDepartmentOnInvoices === null
                        ? null
                        : Boolean(dto.requiresDepartmentOnInvoices),
                requiresProjectOnInvoices: dto.requiresProjectOnInvoices === undefined
                    ? undefined
                    : dto.requiresProjectOnInvoices === null
                        ? null
                        : Boolean(dto.requiresProjectOnInvoices),
                requiresFundOnInvoices: dto.requiresFundOnInvoices === undefined
                    ? undefined
                ...
                cashClearingAccountId: dto.arCashClearingAccountId !== undefined
        ...
        const after = {
            ...
            requiresDepartmentOnInvoices: updated.requiresDepartmentOnInvoices,
        ...
        await this.prisma.auditEvent
            ...
            data: {
                ...
                userId: user.id,
                permissionUsed: permission_catalog_1.PERMISSIONS.SYSTEM.CONFIG_UPDATE,
            },
        })
            .catch(() => undefined);
        return {
    ...
    async uploadOrganisationLogo(req, file) {
        ...
        await this.prisma.auditEvent
            ...
            data: {
                ...
                userId: user.id,
                permissionUsed: permission_catalog_1.PERMISSIONS.SYSTEM.CONFIG_CHANGE,
            },
        })
            .catch(() => undefined);
