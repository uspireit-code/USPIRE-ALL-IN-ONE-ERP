-- CreateEnum
CREATE TYPE "CoaStructureChangeRequestType" AS ENUM ('SEGMENT_DEFINITION', 'SEGMENT_ORDER', 'HIERARCHY_CHANGE', 'REPORTING_NODE_CHANGE', 'TEMPLATE_EXTENSION', 'ROOT_CATEGORY_MODIFICATION', 'OTHER');
