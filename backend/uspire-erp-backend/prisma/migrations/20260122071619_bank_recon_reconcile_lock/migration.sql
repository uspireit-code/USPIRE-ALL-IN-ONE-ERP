...
-- AlterTable
ALTER TABLE "BankStatement" ADD COLUMN     "lockedAt" TIMESTAMP(3),
...
CREATE TABLE "BankReconciliationSnapshot" (
    ...
    "systemBankBalance" DECIMAL(18,2) NOT NULL,
    "outstandingPaymentsTotal" DECIMAL(18,2) NOT NULL,
    "depositsInTransitTotal" DECIMAL(18,2) NOT NULL,
    "adjustedBankBalance" DECIMAL(18,2) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "BankReconciliationSnapshot_bankStatementId_key" ON "BankReconciliationSnapshot"("bankStatementId");

-- CreateIndex
CREATE INDEX "BankReconciliationSnapshot_tenantId_idx" ON "BankReconciliationSnapshot"("tenantId");

-- CreateIndex
CREATE INDEX "BankReconciliationSnapshot_bankAccountId_idx" ON "BankReconciliationSnapshot"("bankAccountId");

-- CreateIndex
CREATE INDEX "BankReconciliationSnapshot_statementEndDate_idx" ON "BankReconciliationSnapshot"("statementEndDate");

-- CreateIndex
CREATE INDEX "BankStatement_tenantId_status_idx" ON "BankStatement"("tenantId", "status");

-- AddForeignKey
ALTER TABLE "BankStatement" ADD CONSTRAINT "BankStatement_reconciledByUserId_fkey" FOREIGN KEY ("reconciledByUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BankStatement" ADD CONSTRAINT "BankStatement_lockedByUserId_fkey" FOREIGN KEY ("lockedByUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BankReconciliationSnapshot" ADD CONSTRAINT "BankReconciliationSnapshot_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BankReconciliationSnapshot" ADD CONSTRAINT "BankReconciliationSnapshot_bankStatementId_fkey" FOREIGN KEY ("bankStatementId") REFERENCES "BankStatement"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BankReconciliationSnapshot" ADD CONSTRAINT "BankReconciliationSnapshot_bankAccountId_fkey" FOREIGN KEY ("bankAccountId") REFERENCES "BankAccount"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BankReconciliationSnapshot" ADD CONSTRAINT "BankReconciliationSnapshot_createdByUserId_fkey" FOREIGN KEY ("createdByUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
