...
const PERMISSIONS = {
  AP_BASIC: ['AP_SUPPLIER_VIEW', 'AP_INVOICE_VIEW', 'AP_BILL_VIEW'],
  AP_OPERATE: [
    'AP_SUPPLIER_CREATE',
    'AP_INVOICE_CREATE',
    'AP_INVOICE_SUBMIT',
  ...
  AP_IMPORT: ['AP_SUPPLIER_IMPORT'],
  AP_APPROVE: ['AP_INVOICE_APPROVE', 'AP_BILL_APPROVE'],
  AP_POST: ['AP_INVOICE_POST', 'AP_BILL_POST'],
  PAYMENTS: ['PAYMENT_CREATE', 'PAYMENT_APPROVE', 'PAYMENT_POST'],
} as const;

const ROLE_MATRIX: Record<string, string[]> = {
  [ROLE_NAMES.OFFICER]: [
    ...PERMISSIONS.AP_BASIC,
    ...PERMISSIONS.AP_OPERATE,
    ...PERMISSIONS.AP_IMPORT,
  ],
